...
class sqlite_test(unittest.TestCase):
    ...
    def test_add_work_with_no_series(self, mock_db):
        ...
        self.assertListEqual(work_fandom_link_table, [(1, 1234, "bg3"), (2, 1234, "poke")])
        self.assertListEqual(work_author_link_table, [(1, 1234, "Bob Bobbert"), (2, 1234, "January")])
    ...
    def test_add_multiple_works_with_no_series(self, mock_db):
        ...
        self.assertListEqual(author_table, [("Bob Bobbert",), ("January",), ("February",)])
        self.assertListEqual(
    ...
    def test_add_work_with_series(self, mock_db):
        ...
        self.assertListEqual(series_fandom_link_table, [(1, 12, "bg3"), (2, 12, "poke")])
        self.assertListEqual(series_author_link_table, [(1, 12, "Bob Bobbert"), (2, 12, "January")])
    ...
    def test_add_series(self, mock_db):
        ...
        self.assertListEqual(work_fandom_link_table, [(1, 1234, "bg3"), (2, 4321, "poke")])
        self.assertListEqual(work_author_link_table, [(1, 1234, "Bobbert"), (2, 4321, "Jade")])
        self.assertListEqual(series_work_link_table, [(1, 6543, 1234, 1), (2, 6543, 4321, 2)])
        self.assertListEqual(series_fandom_link_table, [(1, 6543, "bg3"), (2, 6543, "poke")])
        self.assertListEqual(series_author_link_table, [(1, 6543, "Bobbert"), (2, 6543, "Jade")])
